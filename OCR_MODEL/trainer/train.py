"""
Adapted from https://github.com/clovaai/deep-text-recognition-benchmark/blob/master/train.py
"""
import sys
import time
import random
...
from trainer.my_test import validation
...
with open('config_files/custom.yaml', 'r', encoding='utf-8') as file:
    config= yaml.safe_load(file)

opt= easydict.EasyDict(config)
...
def train(opt, show_number = 2, amp=False):
    ...
    valid_loader = torch.utils.data.DataLoader(
        ...
        num_workers=int(opt.workers), prefetch_factor=None,#512
